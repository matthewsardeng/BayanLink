...
function DashboardLayout() {
  ...
  return (
    <SidebarProvider defaultOpen={!isMobile}>
      <div className="flex min-h-screen w-full bg-zinc-950 font-sans text-[#18181b] p-0 md:p-2.5 gap-0">
        <AppSidebar />
        <div className="flex min-w-0 flex-1 flex-col bg-[#fafafa] rounded-2xl md:rounded-[28px] shadow-2xl overflow-hidden min-h-[calc(100vh-1.25rem)]">
