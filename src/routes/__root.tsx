...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "icon", href: "/web_logo.png", type: "image/png", sizes: "any" },
      { rel: "icon", href: "/web_logo.png", type: "image/png", sizes: "32x32" },
      { rel: "icon", href: "/web_logo.png", type: "image/png", sizes: "192x192" },
      { rel: "apple-touch-icon", href: "/web_logo.png", sizes: "180x180" },
      { rel: "shortcut icon", href: "/web_logo.png", type: "image/png" },
    ],
  }),
