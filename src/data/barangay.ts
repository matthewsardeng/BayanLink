...
export const BARANGAY_INFO = {
  ...
  zipCode: "2009",
  psgcCode: "0330100003",
  correspondenceCode: "035401003",
  classification: "Urban Barangay",
  captain: "Hon. Joseph Gomez Ponce",
  captainTitle: "Punong Barangay (2023–2026)",
  secretary: "Arnaldo Cabales Enz",
  treasurer: "Liezel Barrera Baluyut",
  skChairperson: "Chrishelle Ann Bautista Pabalan",
  address: "Barangay Hall Complex, MacArthur Highway, Balibago, Angeles City, Pampanga",
  coordinates: { lat: 15.1663, lng: 120.5901 },
  hotlineLandline: "(045) 624-5800 / (045) 322-4038",
  hotlineMobile: "+63 999-099-0638",
  ...
  population: [
    ...
    { year: 2024, value: 38510 },
  ],
};

export const BARANGAY_OFFICIALS = [
  { name: "Joseph Gomez Ponce", title: "Punong Barangay", role: "Barangay Chairman" },
  { name: "Karen Bonifacio Nicdao", title: "Barangay Kagawad", role: "Committee Chairman" },
  { name: "Grace Urbano David", title: "Barangay Kagawad", role: "Committee Chairman" },
  { name: "Jennifer Torres Bonifacio", title: "Barangay Kagawad", role: "Committee Chairman" },
  { name: "Louie Jake Pelayo Manalastas", title: "Barangay Kagawad", role: "Committee Chairman" },
  { name: "Ednel Arceo Batac", title: "Barangay Kagawad", role: "Committee Chairman" },
  { name: "Arnold De Jesus Ibay", title: "Barangay Kagawad", role: "Committee Chairman" },
  { name: "Jim Kim De Guzman Timbol", title: "Barangay Kagawad", role: "Committee Chairman" },
  { name: "Chrishelle Ann Bautista Pabalan", title: "SK Chairperson", role: "Youth Leadership" },
  { name: "Arnaldo Cabales Enz", title: "Barangay Secretary", role: "Administrative Office" },
  { name: "Liezel Barrera Baluyut", title: "Barangay Treasurer", role: "Financial Office" },
];
